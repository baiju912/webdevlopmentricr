...
const ResturantProfile = () => {
  ...
  const [istResetPasswordModalOpen, setResetPasswordModalOpen] = useState(false);
  ...
  return (
    <>
      ...
      {istResetPasswordModalOpen && (<ResetPasswordModal onClose = {() => setResetPasswordModalOpen(false)}/>)}
    </>
  );
};
